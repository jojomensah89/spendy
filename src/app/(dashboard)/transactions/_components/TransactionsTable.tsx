...
import { GetTransactionHistoryResponseType } from "@/app/api/history/transactions/route";
import SkeletonWrapper from "@/components/SkeletonWrapper";
import { DataTableColumnHeader } from "@/components/table-data/ColumnHeader";
...
const columns: ColumnDef<TransactionHistoryRow>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div
        className={cn(
          `capitalize rounded-full text-center p-2`,
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <p
        // className={cn(
        //   `text-md rounded-full bg-gray-400/5 text-center p-2 font-medium`,
        //   row.original.type === TransactionType.income
        //     ? "bg-emerald-400/10 text-emerald-500"
        //     : "bg-red-400/10 text-red-500"
        // )}
        className="text-md rounded-full bg-gray-400/5 text-center p-2 font-medium"
      >
